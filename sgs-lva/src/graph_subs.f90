...
subroutine set_graph(MDS_opt)
    ...
    integer, allocatable :: cur_edge_node_array(:,:)
...
start_time=secnds(0.0)
 ...
 !                   to write out the graph: 
    ...
    allocate(cur_edge_node_array(GRID_OUT_LENGTH,2))
 ...
 !                   to write out the graph: 
                    ...
                    cur_edge_node_array(GRID_OUT_LENGTH,1)=cur_node
                    cur_edge_node_array(GRID_OUT_LENGTH,2)=edge_NODE
...
sum_time = secnds(start_time)
Write(*,*) 'computing graph edges and distances ',sum_time,GRID_OUT_LENGTH
