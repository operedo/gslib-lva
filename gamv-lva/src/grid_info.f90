module grid_info
    ...
    real(kind=dp),    public, dimension ( 3 ) :: o, sss,temp_o,temp_sss !origine and block size (x,y,z)
    !real*8,    public, allocatable, dimension (:,:,:,:) :: grid,temp_grid !grid information
    real(kind=dp),    public, allocatable, dimension (:,:,:,:) :: grid,temp_grid !grid information
  ...
  contains
    ...
    subroutine get_index (p, ind, outside)
        real(kind=dp), dimension ( 3 ), intent (in)     :: p !point of interest
